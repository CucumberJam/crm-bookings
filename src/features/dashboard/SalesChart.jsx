...
export default function SalesChart({bookings, numDays}){
  ...
  const data = allDates.map(date => {
    const bookingsAtDate = bookings.filter(booking => isSameDay(date, new Date(booking.created_at)));
    const sales = bookingsAtDate.reduce((acc, cur) => {
      acc.totalSales = acc.totalSales + cur.totalPrice;
      acc.extrasSales = acc.extrasSales + cur.extrasPrice;
      return acc;
